...
<section class="page page-details">
  ...
  <header class="page-head">
    ...
    <a class="btn btn-outline" href="<?= BASE_URL ?>index.php?url=recherche">
  ...
  <div class="details-layout">
    ...
    <div class="card details-card">
      ...
      <div class="details-top">
        ...
        <div class="badges">
          <span class="badge badge-price">
            💳 <?= (int)($trajet['prix'] ?? 0) ?> crédits
          </span>

          <span class="badge badge-places">
            🪑 <?= (int)($trajet['places_restantes'] ?? 0) ?> place(s)
          </span>
        </div>
      </div>
      ...
      <div class="details-grid">
        ...
        <div class="info">
          ...
          <strong>
            <?= htmlspecialchars($conducteur['username'] ?? '—', ENT_QUOTES, 'UTF-8') ?>
          </strong>
        </div>
        ...
        <div class="info">
          ...
          <strong>
            <?= htmlspecialchars($trajet['date_depart'] ?? '—', ENT_QUOTES, 'UTF-8') ?>
          </strong>
        </div>
        ...
        <div class="info">
          ...
          <strong>
            <?= htmlspecialchars($trajet['heure_depart'] ?? '—', ENT_QUOTES, 'UTF-8') ?>
          </strong>
        </div>
      ...
      <div class="card conducteur-card" style="margin-top:16px;">
        ...
        <div class="conducteur-head">
          ...
          <img
            ...
            onerror="this.src='<?= BASE_URL ?>assets/images/conducteur_ecoride.jpg'"
          >
        ...
        <div class="conducteur-avis">
          ...
          <h2 class="card-title" style="margin-top:12px;">
            🗣️ Avis sur le conducteur
          </h2>
      ...
      <div
        ...
        style="margin-top:18px; padding-top:10px;"
      >
        ...
        <?php if (!$isLogged): ?>
          ...
          <a
            class="btn btn-wide"
            href="<?= BASE_URL ?>index.php?url=connexion"
          >
            Se connecter
          </a>
        ...
        <?php elseif ($already): ?>
          ...
          <form
            method="POST"
            action="<?= BASE_URL ?>index.php?url=annulerReservation"
            class="reserve-form"
          >
        ...
        <?php else: ?>
          ...
          <form
            method="POST"
            action="<?= BASE_URL ?>index.php?url=reserver"
            class="reserve-form"
          >
          ...
          <p
            class="hint"
            style="margin-top:10px; opacity:.75;"
          >
    ...
    <aside class="card details-aside">
      ...
      <ul class="details-list">
        ...
        <li>
          Arrivez 5 minutes avant l’heure de départ.
        </li>

        <li>
          Respectez le conducteur et les passagers.
        </li>

        <li>
          En cas d’imprévu, prévenez au plus tôt.
        </li>
      ...
      <div class="aside-note">
        ...
        (contrôle des places, anti double réservation).
      </div>
