  ...
  <?php if (empty($reservations)): ?>
    ...
    <div class="empty-state">
      ...
      <a
        ...
        href="<?= BASE_URL ?>index.php?url=recherche"
      >
    ...
    <div class="reservations-grid">
      ...
      <?php foreach ($reservations as $r): ?>
        ...
        <?php
          ...
          $note = isset($r['conducteur_note_moyenne'])
            ? (float)$r['conducteur_note_moyenne']
            : null;
        ...
        <article class="reservation-card">
          ...
          <div class="reservation-driver">
            ...
            <div class="driver-left">
              ...
              <div class="driver-rating">
                ...
                <?php if ($note !== null): ?>
                  ...
                  <?= htmlspecialchars((string)$note) ?>/5
            ...
            <div class="actions">
              ...
              <a
                class="btn btn-primary"
                href="<?= BASE_URL ?>index.php?url=details&id=<?= $idTrajet ?>"
              >
                Voir le trajet
              </a>
