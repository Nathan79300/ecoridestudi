...
<div class="profil-card">
  ...
  <div class="profil-actions">
    ...
    <a href="<?= BASE_URL ?>index.php?url=recherche" class="btn btn-wide">
      🔍 Trouver un trajet
    </a>

    <a href="<?= BASE_URL ?>index.php?url=mesReservations" class="btn btn-wide">
      📌 Voir mes réservations
    </a>

    <?php if ($isChauffeur): ?>

      <a href="<?= BASE_URL ?>index.php?url=proposer" class="btn btn-wide">
        🚗 Proposer un trajet
      </a>

      <a href="<?= BASE_URL ?>index.php?url=mesTrajets" class="btn btn-wide btn-outline">
        🚙 Voir mes trajets
      </a>

     
      <a href="<?= BASE_URL ?>index.php?url=vehicules" class="btn btn-wide">
        🚘 Gérer mes véhicules
      </a>
